...
class TrafficSignRecognitionUI:
    def __init__(self, master):
        ...
        master.configure(bg="#ACDDDE")

        # Create a label for the main title
        self.main_label = ttk.Label(master, text="TRAFFIC SIGN RECOGNITION AND VOICE ALERT SYSTEM", font=('Arial', 35, 'bold'))
        ...
        self.text_area = tk.Text(master, height=10, width=80, font=('Arial Unicode MS', 15))
